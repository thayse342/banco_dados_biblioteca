...
-- Populando os registros com as informações na tabela endereços
...
-- Populando os registros com as informações na tabela editoras
...
-- Populando os registros com as informações na tabela generos
...
-- Populando os registros com as informações na tabela pessoas
...
-- Populando os registros com as informações na tabela usuarios
...
-- Populando os registros com as informações na tabela funcionarios
...
-- Populando os registros com as informações na tabela autores
...
-- Populando os registros com as informações na tabela livros
...
-- Populando os registros com as informações na tabela emprestimos
